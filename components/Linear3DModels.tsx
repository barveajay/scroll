  ...
  <div className="relative w-full h-full perspective-[1200px]">
    <svg viewBox="0 0 800 600" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full animate-float-slow">
      ...
      <g className="animate-pulse-slow">
        ...
        <rect x="375" y="260" width="60" height="40" stroke="indigo" strokeWidth="0.5" strokeOpacity="0.4" transform="skewY(-25)" />
      </g>

      {/* Floating Social Nodes */}
      <g className="animate-float">
        {/* "Like" Icon 3D representation */}
        <circle cx="550" cy="250" r="15" stroke="#6366f1" strokeWidth="1" />
        <path d="M550 235 L550 265 M535 250 L565 250" stroke="#6366f1" strokeWidth="1" />
        <line x1="450" y1="250" x2="535" y2="250" stroke="#6366f1" strokeWidth="0.5" strokeDasharray="4 4" strokeOpacity="0.4" />
      </g>
      ...
      <path d="M200 400 C 300 450, 400 350, 600 400" stroke="url(#grad-indigo)" strokeWidth="2" strokeDasharray="10 5" className="line-draw" />
    </svg>
  </div>
);
...
export const GrowthEngine3D = () => (
  <svg viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full opacity-30">
    ...
    <g transform="translate(200, 100)">
      ...
      <ellipse cx="0" cy="200" rx="50" ry="15" stroke="indigo" strokeWidth="1" strokeOpacity="0.5" />
      ...
      <circle r="2" fill="white" className="animate-ping">
        <animateMotion dur="3s" repeatCount="indefinite" path="M-80 10 L-40 190" />
      </circle>
      <circle r="2" fill="indigo" className="animate-ping">
