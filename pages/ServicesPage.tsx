    ...
    <div className="pt-32 pb-24 bg-brand-black">
      <section className="max-w-7xl mx-auto px-6">
        <div className="mb-24 text-center max-w-4xl mx-auto">
          <div className="text-brand-primary font-bold uppercase tracking-widest mb-4">Our Expertise</div>
          <h1 className="text-6xl md:text-8xl font-black font-heading mb-8 tracking-tighter text-brand-white">POWERING YOUR <span className="text-brand-accent italic">DIGITAL</span> ENGINE.</h1>
            ...
            return (
              <div key={service.id} className={`flex flex-col ${idx % 2 === 0 ? 'lg:flex-row' : 'lg:flex-row-reverse'} gap-16 items-center`}>
                <div className="lg:w-1/2">
                  <div className="w-20 h-20 rounded-3xl bg-brand-primary/10 flex items-center justify-center mb-8 text-brand-primary border border-brand-primary/20">
                    <Icon size={40} />
                  </div>
                  <h2 className="text-4xl font-black font-heading mb-6 tracking-tight text-brand-white">{service.title}</h2>
